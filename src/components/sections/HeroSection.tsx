    ...
    >
      ...
      <div className="lg:grid lg:grid-cols-[55fr_45fr]">
        ...
        >
          ...
          <div
            aria-hidden="true"
            className="lg:hidden pointer-events-none select-none absolute right-[-0.02em] bottom-[-0.1em] font-black leading-none"
            style={{
          ...
          <h1
            id="hero-heading"
            className="hero-hl mb-5 md:mb-7"
